...
$sql = "SELECT p.txt , p.picture , p.Create_at , p.User_id , p.Posts_id , u.userName
  FROM posts AS p JOIN users AS u WHERE p.User_id = u.Id";
      ...
      if ($res->num_rows > 0) {
       ...
       echo '<div class="postCard">'.
               '<div class="postForm">'.
                   ...
                   '</div>'.
                  '<div class="imgPost">
                <p class="contentBoxComment">'.$row["txt"].'</p>'. 
                   '<img src='.$row['picture'] .'class="img-fluid rounded" >'.
                   '</div>'. '<br>' .
                   ...
                   ' <form action="" method="post">'.
                       '<div class="flexPostForm">'.
                           '<div class="imgPostForm">'.
                               '<img src="img/man.jpg" alt="">'.
                           '</div>'.
                           '<input name = "Posts_id"   type="hidden"  value= '.$row['Posts_id'] .'>'.
            ...
            while($row1 = $res1->fetch_assoc()) {
                ...
                <div class="flexPostForm">
                    ...
                    <div class="boxComment">
                        <p class="nameBoxComment">'. $row1['userName'] .'</p>
